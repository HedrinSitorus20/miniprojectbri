...
CREATE TABLE `actors` (
                          ...
                          `role_id` int(15) UNSIGNED DEFAULT NULL,
...
INSERT INTO `actors` (`id`, `username`, `password`, `role_id`, `verified`, `active`, `created_at`, `updated_at`, `deleted_at`) VALUES
                                                                                                                                   ...
                                                                                                                                   (20, 'admin', '$2a$10$d0zgM0ZFmeCnLINc/qQhUO.QGW7PBv7L6WF.DPtKWaNspdvj0JWDO', 2, 'false', 'false', '2023-06-06 08:21:24', '2023-06-06 10:48:02', NULL);
...
INSERT INTO `customers` (`id`, `first_name`, `last_name`, `email`, `avatar`, `created_at`, `updated_at`, `deleted_at`) VALUES
                                                                                                                           (1, 'hedrin', '123456', 'hedrinsitorus@gmail.com', 'https://google.com', '2023-06-04 06:28:25', '2023-06-04 06:28:25', NULL),
                                                                                                                           (4, 'hedrin', '123456', 'lintangtimur2@gmail.com', 'https://google.com', '2023-06-05 08:19:31', '2023-06-05 08:19:31', NULL),
                                                                                                                           (5, 'putra', 'sitorus', 'stefanus@gmail.com', 'https://google.com', '2023-06-06 07:54:44', '2023-06-06 07:54:44', NULL),
                                                                                                                           (8, 'putra01', 'sitorus01', 'stefanus2@gmail.com', 'https://google.com', '2023-06-06 07:57:20', '2023-06-06 07:57:20', NULL),
                                                                                                                           (10, 'putra02', 'sitorus02', 'stefanus3@gmail.com', 'https://google.com', '2023-06-06 10:57:13', '2023-06-06 10:57:13', '2023-06-06 10:58:51'),
...
CREATE TABLE `register_approvals` (
                                      `id` bigint(25) UNSIGNED NOT NULL,
                                      `admin_id` bigint(25) UNSIGNED DEFAULT NULL,
                                      `super_admin_id` bigint(25) UNSIGNED DEFAULT NULL,
...
INSERT INTO `register_approvals` (`id`, `admin_id`, `super_admin_id`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
    (2, 20, 1, 'rejected', '2023-06-06 08:21:24', '2023-06-06 10:30:38', NULL);
...
--
ALTER TABLE `actors`
    MODIFY `id` bigint(25) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `customers`
--
ALTER TABLE `customers`
    MODIFY `id` bigint(25) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
